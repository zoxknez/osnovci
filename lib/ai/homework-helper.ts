...
export async function getHomeworkHelp(
  ...
  try {
    ...
    const analysis = await analyzeProblem(problemText, request.subject, request.grade);
    ...
    const similarProblems = await generateSimilarProblems(analysis, request.grade);
...
async function analyzeProblem(
  ...
  if (subject.toLowerCase().includes("matematik")) {
    ...
    if (lowerText.includes("pomnoži") || lowerText.includes("×") || lowerText.includes("*")) {
      return {
    ...
    if (lowerText.includes("podeli") || lowerText.includes("÷") || lowerText.includes("/")) {
      return {
  ...
  switch (analysis.problemType) {
    case "sabiranje":
      steps.push(
        {
          number: 1,
          instruction: "Pročitaj zadatak pažljivo. Koje brojeve treba da saberem?",
          explanation: "Prvo moraš da razumeš šta traži zadatak. Pronađi sve brojeve koje treba da saberem.",
          checkPoint: "Proveri da li si našao/la sve brojeve iz zadatka.",
        },
        {
          number: 2,
          instruction: "Napiši brojeve jedan ispod drugog, poravnaj ih po deseticama.",
          explanation: "Ako su brojevi dvocifreni ili veći, poravnaj ih tako da su jedinice ispod jedinica, desetice ispod desetica.",
          hint: "Ako je 23 + 45, napiši:\n  23\n+ 45\n---",
        },
        {
          number: 3,
          instruction: "Saberi prvo jedinice. Ako je rezultat veći od 9, prenesi deseticu.",
          explanation: "Počni sa desne strane. Saberi jedinice. Ako dobiješ 10 ili više, napiši jedinicu i prenesi 1 na desetice.",
          checkPoint: "Da li si sabrao/la jedinice? Da li treba da preneseš deseticu?",
        },
        {
          number: 4,
          instruction: "Saberi desetice (i prenesenu deseticu ako je ima).",
          explanation: "Sada saberi desetice. Ne zaboravi da dodaš prenesenu deseticu ako je ima.",
        },
        {
          number: 5,
          instruction: "Proveri svoj odgovor - da li ima smisla?",
          explanation: "Uvek proveri svoj odgovor. Ako sabiraš dva pozitivna broja, odgovor mora biti veći od oba broja.",
        }
      );
      break;
    ...
    case "oduzimanje":
      steps.push(
        {
          number: 1,
          instruction: "Pročitaj zadatak. Koji broj je veći? Od većeg oduzmi manji.",
          explanation: "Prvo moraš da razumeš koji broj je veći. Uvek oduzimamo manji od većeg.",
        },
        {
          number: 2,
          instruction: "Napiši brojeve jedan ispod drugog, veći gore.",
          explanation: "Veći broj ide gore, manji dole. Poravnaj ih po ciframa.",
        },
        {
          number: 3,
          instruction: "Oduzmi jedinice. Ako ne možeš, pozajmi od desetica.",
          explanation: "Počni sa desne strane. Ako je gornja cifra manja, pozajmi 1 od desetice.",
          hint: "Ako je 5 - 7, pozajmi od desetice: 15 - 7 = 8",
        },
        {
          number: 4,
          instruction: "Oduzmi desetice (ne zaboravi da si pozajmio/la).",
          explanation: "Sada oduzmi desetice. Ne zaboravi da si pozajmio/la jedinicu.",
        },
        {
          number: 5,
          instruction: "Proveri: da li je odgovor manji od većeg broja?",
          explanation: "Uvek proveri - ako oduzimaš, odgovor mora biti manji od većeg broja.",
        }
      );
      break;
    ...
    case "jednačina":
      steps.push(
        {
          number: 1,
          instruction: "Pročitaj jednačinu. Šta traži zadatak? Koja je nepoznata?",
          explanation: "Pronađi nepoznatu (obično označena sa x ili drugim slovom).",
        },
        {
          number: 2,
          instruction: "Izoluj nepoznatu na jednoj strani jednačine.",
          explanation: "Pokušaj da nepoznatu ostaviš sama na jednoj strani. Koristi suprotne operacije.",
        ...
        {
          number: 4,
          instruction: "Proveri svoj odgovor - zameni x u originalnoj jednačini.",
          explanation: "Uvek proveri - zameni svoj odgovor u originalnu jednačinu i proveri da li je tačna.",
        }
      );
      break;
      ...
      steps.push(
        {
          ...
          explanation: "Prvo moraš da razumeš šta traži zadatak. Podvuci ključne reči.",
        },
        {
          number: 2,
        ...
        },
        {
          ...
          explanation: "Razmisli o tome kako bi mogao/la da rešiš ovaj zadatak. Koje korake treba da uradiš?",
        },
        {
          number: 4,
          instruction: "Reši zadatak korak po korak.",
          explanation: "Sada reši zadatak, korak po korak. Ne žuri, proveri svaki korak.",
        },
        {
          number: 5,
          instruction: "Proveri svoj odgovor. Da li ima smisla?",
          explanation: "Uvek proveri svoj odgovor. Da li je logičan? Da li odgovara na pitanje iz zadatka?",
        }
      );
  }
  ...
  switch (analysis.problemType) {
    case "sabiranje":
      if (grade <= 3) {
        problems.push(
          {
            problem: "Ana ima 15 olovaka, a Marko ima 23 olovke. Koliko olovaka imaju zajedno?",
            solutionSteps: [
          ...
          {
            problem: "U biblioteci je 28 knjiga na srpskom i 34 knjige na engleskom. Koliko knjiga ima ukupno?",
            solutionSteps: [
...
function getLearningTips(subject: string, _problemType: string): string[] {
  ...
  tips.push("Ako zaglaviš, probaj da razmisliš o sličnom zadatku koji znaš da rešiš.");
