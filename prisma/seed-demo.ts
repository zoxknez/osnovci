...
async function main() {
  ...
  const subjects = await Promise.all([
    ...
    prisma.subject.create({
      data: { name: "Tehničko", color: "#78716c", icon: "🔧" },
    }),
    prisma.subject.create({
      data: { name: "Građansko vaspitanje", color: "#a855f7", icon: "🤝" },
    }),
  ]);
  ...
  const stickers = await Promise.all([
    ...
    prisma.sticker.create({
      data: { code: "STAR", name: "Zvezda", icon: "⭐", cost: 20, minLevel: 2 },
    }),
    prisma.sticker.create({
      data: {
        code: "ROCKET",
    ...
    prisma.sticker.create({
      data: { code: "HEART", name: "Srce", icon: "❤️", cost: 15, minLevel: 1 },
    }),
    prisma.sticker.create({
      data: { code: "FIRE", name: "Vatra", icon: "🔥", cost: 30, minLevel: 3 },
    }),
    prisma.sticker.create({
      data: { code: "CLAP", name: "Aplauz", icon: "👏", cost: 25, minLevel: 2 },
    }),
    prisma.sticker.create({
      data: {
        code: "MUSCLE",
  ...
  const shopItems = await Promise.all([
    ...
    prisma.shopItem.create({
      data: {
        ...
        assetUrl: "/avatars/pirate-hat.png",
        minLevel: 5,
      },
    }),
    prisma.shopItem.create({
      data: {
        ...
        cost: 50,
        type: "AVATAR_ACCESSORY",
        assetUrl: "/avatars/sunglasses.png",
        minLevel: 2,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Kruna",
        description: "Za pravog šampiona",
        cost: 200,
        type: "AVATAR_ACCESSORY",
        assetUrl: "/avatars/crown.png",
        minLevel: 10,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Maska superheroja",
        description: "Spasi svet! 🦸",
        cost: 150,
        type: "AVATAR_ACCESSORY",
        assetUrl: "/avatars/hero-mask.png",
        minLevel: 8,
      },
    }),
    // Themes
    prisma.shopItem.create({
      data: {
        name: "Noćna tema",
        description: "Tamna strana 🌙",
        cost: 75,
        type: "THEME",
        assetUrl: "/themes/dark.json",
        minLevel: 3,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Šarena tema",
        description: "Svi boje sveta! 🌈",
        cost: 100,
        type: "THEME",
        assetUrl: "/themes/rainbow.json",
        minLevel: 5,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Kosmička tema",
        description: "Putovanje kroz svemir 🚀",
        cost: 150,
        type: "THEME",
        assetUrl: "/themes/space.json",
        minLevel: 10,
      },
    }),
    // Badges
    prisma.shopItem.create({
      data: {
        name: "Matematičar",
        description: "Za ljubitelje brojeva",
        cost: 50,
        type: "BADGE",
        assetUrl: "/badges/math.png",
        minLevel: 1,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Čitalac",
        description: "Knjigoljubac",
        cost: 50,
        type: "BADGE",
        assetUrl: "/badges/reader.png",
        minLevel: 1,
      },
    }),
    prisma.shopItem.create({
      data: {
        name: "Sportista",
        description: "Brži, viši, jači!",
        cost: 50,
        type: "BADGE",
        assetUrl: "/badges/sports.png",
        minLevel: 1,
      },
    }),
    // Frames
  ...
  for (const student of DEMO_STUDENTS) {
    ...
    const userId =
      student.email === "marko@demo.rs" ? "demo-student-id" : undefined;
  ...
  for (const guardian of DEMO_GUARDIANS) {
    ...
    const childStudent = createdStudents.find(
      (s) =>
        DEMO_STUDENTS.find((ds) => ds.email === guardian.childEmail)?.name ===
        s.name,
    );
  ...
  const achievementTypes = [
    {
      type: "FIRST_HOMEWORK",
      title: "Prvi korak",
      description: "Završio prvi domaći zadatak!",
      icon: "🎯",
      xpReward: 50,
    ...
    },
    {
      type: "HOMEWORK_10",
      title: "Marljivi đak",
      description: "10 završenih domaćih!",
      icon: "📚",
      xpReward: 100,
      rarity: "COMMON" as const,
    },
    {
      type: "STREAK_7",
      title: "Nedelja discipline",
      description: "7 dana zaredom aktivnosti!",
      icon: "🔥",
      xpReward: 150,
    ...
    {
      type: "STREAK_14",
      title: "Dvonedeljna pobeda",
      description: "14 dana streak!",
      icon: "⚡",
      xpReward: 250,
      rarity: "RARE" as const,
    },
    {
      type: "LEVEL_5",
      title: "Napredni učenik",
      description: "Dostigao nivo 5!",
      icon: "⭐",
      xpReward: 200,
      rarity: "COMMON" as const,
    },
    ...
    },
    {
      type: "EARLY_BIRD",
      title: "Rana ptica",
      description: "Učenje pre 7 ujutru!",
      icon: "🌅",
      xpReward: 75,
      rarity: "COMMON" as const,
    },
  ...
  for (const student of createdStudents) {
    const studentSubjects = subjects.slice(
      0,
  ...
  const homeworkItems = [
    {
      ...
      description:
        "Rešiti zadatke 1-10 iz udžbenika strana 45. Posebno obratiti pažnju na diskriminantu!",
    ...
    },
    {
      ...
      description:
        "Napisati esej od 200-300 reči o proleću i buđenju prirode. Koristiti bar 5 epiteta i 3 poređenja.",
    ...
    },
    {
      ...
      description:
        "Workbook stranice 23-25. Svi zadaci! Naučiti nepravilne glagole sa strane 26.",
    ...
    },
    {
      ...
      description:
        "Odgovoriti na pitanja 1-8 na kraju poglavlja. Objasniti prvi i drugi Njutnov zakon.",
    ...
    },
    {
      ...
      description:
        "Nacrtati vremensku liniju od 500. do 1500. godine sa najvažnijim događajima.",
    ...
    },
    {
      ...
      description:
        "Na slepoj mapi Srbije označiti sve glavne reke i njihove pritoke.",
      dueDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
      priority: "NORMAL" as const,
    ...
    },
    {
      ...
      description:
        "Nacrtati biljnu i životinjsku ćeliju. Označiti sve organele sa imenima.",
    ...
    },
    {
      ...
      description:
        "Napraviti jednostavnu HTML stranicu sa tvojim podacima, slikama i linkovima.",
    ...
    },
    {
      ...
      description:
        "Vežbanka strana 12, zadaci 1-15. Proširiti na zajednički imenilac!",
      dueDate: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
      priority: "NORMAL" as const,
    ...
    },
    {
      ...
      description:
        "Pročitati prvih 5 poglavlja i napisati kratak rezime svakog.",
  ...
  const events = [
    {
      type: "EXAM",
      title: "Kontrolni iz matematike",
      description: "Kvadratne jednačine i sistemi",
      dateTime: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
      location: "Učionica 101",
    },
    {
      type: "EXAM",
      title: "Pismeni iz srpskog",
      description: "Esej na zadatu temu",
      dateTime: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000),
      location: "Učionica 205",
    },
    {
      type: "MEETING",
      title: "Roditeljski sastanak",
      description: "Kraj prvog polugodišta",
      dateTime: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000),
      location: "Učionica 5/A",
    },
    {
      type: "TRIP",
      title: "Ekskurzija - Beograd",
      description: "Poseta muzeju i zoo vrtu",
      dateTime: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000),
      location: "Polazak ispred škole u 7:00",
    },
    {
      type: "COMPETITION",
      title: "Školsko takmičenje iz matematike",
      description: "Prijava do petka!",
  ...
  const knowledgeItems = [
    {
      subjectId: matematika.id,
      title: "Kvadratna jednačina - formula",
      type: "NOTE" as const,
      content:
        "x = (-b ± √(b² - 4ac)) / 2a\n\nDiskriminanta D = b² - 4ac\n- D > 0: dva rešenja\n- D = 0: jedno rešenje\n- D < 0: nema realnih rešenja",
      isPinned: true,
      tags: JSON.stringify(["formula", "jednačine"]),
    },
    {
      subjectId: fizika.id,
      ...
      type: "NOTE" as const,
      content:
        "1. Zakon inercije: Telo miruje ili se kreće ravnomerno pravolinijski dok ga sila ne primora da promeni to stanje.\n\n2. F = m × a (Sila = masa × ubrzanje)\n\n3. Akcija = Reakcija",
      isPinned: true,
      tags: JSON.stringify(["njutn", "zakoni", "mehanika"]),
    },
    {
      subjectId: engleski.id,
      title: "Koristan link - Irregular Verbs",
      type: "LINK" as const,
      content: "https://www.englishpage.com/irregularverbs/irregularverbs.html",
      isPinned: false,
      tags: JSON.stringify(["glagoli", "gramatika"]),
    },
    {
      subjectId: istorija.id,
      title: "Srednji vek - beleške",
      type: "NOTE" as const,
      content:
        "Srednji vek (5-15. vek)\n\n✓ Pad Rimskog carstva 476.\n✓ Krunisanje Karla Velikog 800.\n✓ Veliki raskol 1054.\n✓ Pad Carigrada 1453.\n\nFeudalizam: kralj → plemstvo → vitezovi → seljaci",
      isPinned: false,
      tags: JSON.stringify(["srednji vek", "beleške"]),
    },
    {
      subjectId: biologija.id,
      title: "Delovi ćelije",
      ...
      isPinned: true,
      tags: JSON.stringify(["ćelija", "biologija"]),
    },
  ];
  ...
  for (const session of focusSessions) {
    const startTime = new Date(
      Date.now() - session.daysAgo * 24 * 60 * 60 * 1000,
    );
  ...
  const notifications = [
    {
      type: "HOMEWORK_DUE",
      title: "Domaći ističe sutra!",
      message: "Past Simple Tense - vežbe iz Engleskog jezika ističe sutra.",
      read: false,
    },
    {
      type: "ACHIEVEMENT_UNLOCKED",
      title: "Nova značka!",
      message: "Osvojio si značku 'Nedelja discipline' za 7 dana zaredom! 🔥",
      read: false,
    },
    {
      type: "HOMEWORK_REVIEWED",
      title: "Domaći pregledan",
      message: "Mama je pregledala tvoj domaći iz matematike: Odličan rad! ⭐",
      read: true,
    },
    {
      type: "EVENT_REMINDER",
      title: "Podsetnik",
      message: "Kontrolni iz matematike za 7 dana!",
      read: true,
    },
    {
      type: "LEVEL_UP",
      title: "Novi nivo!",
      message: "Čestitamo! Dostigao si nivo 12! 🎉",
      read: true,
    },
  ];
  ...
  const activityLogs = [
    { type: "LOGIN", description: "Prijava na sistem" },
    {
      ...
      description: "Kreiran domaći: Kvadratne jednačine",
    },
    {
      type: "HOMEWORK_UPDATED",
      description: "Ažuriran status domaćeg: Razlomci",
    },
    {
      type: "PROFILE_UPDATED",
      description: "Ažuriran profil - dodata biografija",
    },
    {
      type: "PARENT_LINKED",
      description: "Povezan sa roditeljom: Jelena Marković",
    },
  ];
  ...
  console.log(
    "║          🎉 KOMPLETAN SEED ZAVRŠEN - DEMO SPREMNI! 🎉             ║",
  );
  console.log(
    "║                                                                    ║",
  );
