...
export async function getHomeworkProgressAction(
  homeworkId: string,
): Promise<ActionResponse> {
  try {
    await getSession();
...
export async function canStartTaskAction(
  taskId: string,
): Promise<ActionResponse> {
  try {
    await getSession();
...
export async function createFromTemplateAction(
  ...
  try {
    ...
    log.info("Homework created from template", {
      templateId,
...
export async function bulkCompleteHomeworkAction(
  homeworkIds: string[],
): Promise<ActionResponse> {
  try {
    await getSession();
...
export async function bulkDeleteHomeworkAction(
  homeworkIds: string[],
): Promise<ActionResponse> {
  try {
    await getSession();
...
export async function getBulkActionPreviewAction(
  homeworkIds: string[],
): Promise<ActionResponse> {
  try {
    await getSession();
...
export async function getHomeworkWithSubtasksAction(
  homeworkId: string,
): Promise<ActionResponse> {
  try {
    await getSession();
